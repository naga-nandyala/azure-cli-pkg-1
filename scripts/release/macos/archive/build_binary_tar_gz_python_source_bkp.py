...
def build_binary_tar_gz(*, platform_tag: str) -> None:
    """Build self-contained binary tar.gz from python.org source."""
    ...
    # Verify we can build for target architecture
    ...
    with tempfile.TemporaryDirectory(prefix="azure-cli-python-source-") as tmp_dir_str:
        ...
        # Step 12: Create tar.gz archive
        print("\n12. Creating tar.gz archive...")
...
def main(argv: Optional[Iterable[str]] = None) -> None:
    ...
    try:
        # Validate Python version if not skipped
